...
node ./package-graph.js --input ./packageSet.json --force lib-deps --output ./libDeps.txt --deps ./finished-dependencies.txt

node ./package-graph.js --input ./packageSet.json --force lib-deps --output ./originalPackagesList.txt
