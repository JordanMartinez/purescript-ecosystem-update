...
initCmd = do
  ...
  writeTextFile UTF8 changelogFiles.readmeFile $ Array.intercalate "\n"
    [ "## What is this?"
    , ""
    , "This directory stores the output of the `ecosystemChangelog` command: "
    , Array.fold
      [ "- 'uninteresting' file: indicates libraries whose only changes were "
      , "the ones applied to all libraries in the update."
      ]
    , "- `missing` file: indicates libraries that did not have a CHANGELOG.md file."
    , Array.fold
      [ "- `notes` file: the actual changelog to use for an ecosystem changelog. "
      , "It may need to be further cleaned up, but should automate most of the work for you."
      ]
    , ""
